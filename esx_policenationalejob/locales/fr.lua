Locales['fr'] = {
  ...
  ['bullet_wear'] = 'Gilet PB',
  ['bullet2_wear'] = 'Gilet Jaune',
  ['bullet3_wear'] = 'Gilet Police PB',
  ['bullet4_wear'] = 'Gilet Bac PB',
  ...
  ['being_searched'] = 'vous êtes ~y~recherché(e)~s~ par la ~b~pnrie~s~',
  -- Vehicle interaction
  ...
  ['barriere'] = 'barrière',
  ['cone'] = 'Cone',
  ['routebarrer'] = 'Barriere route barrer',   
  ['droite'] = 'Panneau tourner a droite',
  ['gauche'] = 'Panneau tourner a gauche',
  ['interdit'] = 'Panneau Interdit',
  ['inondation'] = 'Panneau Inondation',
  ['box'] = 'Herse',
  -- ID Card Menu
  ['name'] = 'nom: %s',
  ['job'] = 'métier: %s',
